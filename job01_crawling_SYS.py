...
try:
    for i in range(20, 22):
        url = 'https://movie.naver.com/movie/sdb/browsing/bmovie.naver?open=2017&page={}'.format(i)
        titles = []
        reviews = []
        ...
        df_review_20.to_csv('./crawling_data/reviews_test2_{}.csv'.format( i), index=False)
except:
    print('totally error')
finally:
    driver.close()
